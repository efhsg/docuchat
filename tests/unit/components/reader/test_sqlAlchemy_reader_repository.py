...
class TestSqlalchemyReaderRepository(unittest.TestCase):
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    @patch(
        "components.reader.sqlAlchemy_reader_repository.SqlalchemyReaderRepository.domain_exists",
        return_value=False,
    )
    def test_create_domain_success(self, mock_domain_exists, mock_get_session):
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_create_domain_with_default_name_failure(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_list_domains(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_list_domains_without_default(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_delete_domain_success(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_update_domain_success(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_update_default_domain_failure(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
        default_domain_name = reader_repository.config.default_domain_name
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_delete_default_domain_failure(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
        default_domain_name = reader_repository.config.default_domain_name
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_delete_texts_bulk_success(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
    ...
    def test_get_text_by_name_found(self, mock_decompress, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_list_text_names(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_save_text_success(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(
            session=mock_session, compressor=ZlibTextCompressor()
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_text_exists_found(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
    ...
    @patch("components.reader.sqlAlchemy_reader_repository.MySQLConnector.get_session")
    def test_text_exists_not_found(self, mock_get_session):
        mock_session = MagicMock()
        mock_get_session.return_value = mock_session
        mock_session.query.return_value.filter_by.return_value.first.return_value = None
        reader_repository = SqlalchemyReaderRepository(session=mock_session)
