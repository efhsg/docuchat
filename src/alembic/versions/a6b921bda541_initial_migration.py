...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['chunk_process_id'], ['chunk_processes.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['embedding_process_id'], ['embedding_processes.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
